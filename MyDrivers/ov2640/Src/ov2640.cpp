#include "ov2640/Inc/ov2640.hpp"
#include "ov2640/Inc/ov2640cfg.h"
#include "print/Inc/print.h"
#include "ov2640/Inc/sccb.h"


uint8_t ov2640::init(void)
{
	uint16_t reg;
    printf("-------ov2640 init---------\r\n");
    //control_led(ON);
    HAL_GPIO_WritePin(DCMI_PWDN_GPIO_Port, DCMI_PWDN_Pin, GPIO_PIN_RESET);//POWER ON
    HAL_Delay(10);
...
void ov2640::indow_set(uint16_t sx,uint16_t sy,uint16_t width,uint16_t height)
{
	uint16_t endx;
	uint16_t endy;
	uint8_t temp;
